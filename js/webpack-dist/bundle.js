...
/***/ "./src/async-function/create-permission.js":
/*!*************************************************!*\
  !*** ./src/async-function/create-permission.js ***!
  \*************************************************/
/*! no static exports found */
...
var _backend = __webpack_require__(/*! ../model/backend.prototype */ "./src/model/backend.prototype.js");
...
function () {
  ...
  /*#__PURE__*/
  regeneratorRuntime.mark(function _callee(fetchFromBackend) {
    var data, fieldCssClasses;
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 2:
            ...
            if (!(0, _isEmpty2.default)(data.taxonomyRelationFieldNames)) {
            ...
            return _context.abrupt("return", new _backend2.default(data.taxonomyRelationFieldNames, data.permissions.userDisplayNames, data.permissions.roleLabels, fieldCssClasses));
  ...
  return function createPermission(_x) {
...
function () {
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            url = '/admin/permissions-by-term/access-info-by-url?url=' + window.location.pathname;
  ...
  return function fetchFromBackend() {
    return _ref.apply(this, arguments);
  };
}();
...
var DomClient = function DomClient(document, permissionsOutput, drupal) {
...
DomClient.prototype.renderPermissionsInfo = function () {
  var allowedUsersHtml = '<b>' + this.drupal.t('Allowed users:') + '</b> ';
  ...
  var allowedRolesHtml = '<b>' + this.drupal.t('Allowed roles:') + '</b> ';
  ...
  var generalInfoText = this.drupal.t("This widget shows information about taxonomy term related permissions. It's being updated, as soon you make any related changes in the form.");
...
DomClient.prototype._computeTidsByAutocomplete = function (fieldWrapperCSSClass) {
  var selectedTids = [];
  var autocompleteInputs = this.document.querySelectorAll(fieldWrapperCSSClass + ' input.form-autocomplete');
  var _iteratorNormalCompletion = true;
  var _didIteratorError = false;
  var _iteratorError = undefined;

  try {
    for (var _iterator = autocompleteInputs[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
      var autocompleteInput = _step.value;

      if (autocompleteInput.value !== undefined && includes(autocompleteInput.value, '(') && includes(autocompleteInput.value, ')')) {
        var tidsInBrackets = autocompleteInput.value.match(/\(\d+\)/g);
...
DomClient.prototype._computeTidsBySelect = function (fieldWrapperCSSClass) {
  ...
  for (var inputTypesIndex = 0; inputTypesIndex <= inputTypes.length; inputTypesIndex++) {
    var value = this.document.querySelector(fieldWrapperCSSClass + ' select').value;
...
DomClient.prototype._computeTidsByCheckbox = function (formElementCssClass) {
  ...
  try {
    for (var _iterator2 = this.document.querySelectorAll(formElementCssClass + ' input[type="checkbox"]')[Symbol.iterator](), _step2; !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {
...
DomClient.prototype.computeTids = function (formElementCssClass) {
  ...
  var inputType = this._getInputType(formElementCssClass);
...
/***/ "./src/client/permission-output-collector.prototype.js":
/*!*************************************************************!*\
  !*** ./src/client/permission-output-collector.prototype.js ***!
  \*************************************************************/
/*! no static exports found */
 ...
 */
var PermissionsOutputCollector = function PermissionsOutputCollector(permissionOutput) {
...
PermissionsOutputCollector.prototype._collectRoles = function (permissions, tidsByInputs) {
  ...
  try {
    for (var _iterator = tidsByInputs[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
      var tids = _step.value;

      for (var tidToRole in permissions.tidsToRoles) {
        if ((0, _includes2.default)(tids, tidToRole)) {
          var _iteratorNormalCompletion2 = true;
          var _didIteratorError2 = false;
          var _iteratorError2 = undefined;

          try {
            for (var _iterator2 = permissions.tidsToRoles[tidToRole][Symbol.iterator](), _step2; !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {
              var role = _step2.value;

              if (!(0, _includes2.default)(this.permissionOutput.getRoles(), role)) {
...
PermissionsOutputCollector.prototype._collectUsers = function (permissions, tidsByInputs) {
  ...
  try {
    for (var _iterator3 = tidsByInputs[Symbol.iterator](), _step3; !(_iteratorNormalCompletion3 = (_step3 = _iterator3.next()).done); _iteratorNormalCompletion3 = true) {
      var tids = _step3.value;

      for (var tidToUsername in permissions.tidToUsernames) {
        if ((0, _includes2.default)(tids, tidToUsername)) {
          var _iteratorNormalCompletion4 = true;
          var _didIteratorError4 = false;
          var _iteratorError4 = undefined;

          try {
            for (var _iterator4 = permissions.tidToUsernames[tidToUsername][Symbol.iterator](), _step4; !(_iteratorNormalCompletion4 = (_step4 = _iterator4.next()).done); _iteratorNormalCompletion4 = true) {
              var username = _step4.value;

              if (!(0, _includes2.default)(this.permissionOutput.getUsernames(), username)) {
...
exports.default = PermissionsOutputCollector;
...
var TermCollector = function TermCollector() {
  this.selectedTids = [];
};
...
TermCollector.prototype.termExists = function (key) {
  ...
  for (var i = 0; i < this.selectedTids.length; i++) {
...
TermCollector.prototype.addSelectedTids = function (tids) {
  ...
  if (!isEmpty(tids)) {
    flatten(tids).forEach(function (tid) {
      if (isArray(tid)) {
        throw 'Wanted to add array. Must be string.';
      }

      _this.addSelectedTid(tid);
    });
  }
};
...
var _createPermission = __webpack_require__(/*! ../async-function/create-permission */ "./src/async-function/create-permission.js");

var _createPermission2 = _interopRequireDefault(_createPermission);

var _fetchFromBackend = __webpack_require__(/*! ../async-function/fetch-from-backend */ "./src/async-function/fetch-from-backend.js");

var _fetchFromBackend2 = _interopRequireDefault(_fetchFromBackend);

var _domClient = __webpack_require__(/*! ../client/dom-client.prototype */ "./src/client/dom-client.prototype.js");

var _domClient2 = _interopRequireDefault(_domClient);

var _permissionOutput = __webpack_require__(/*! ../model/permission-output.prototype */ "./src/model/permission-output.prototype.js");

var _permissionOutput2 = _interopRequireDefault(_permissionOutput);

var _permissionOutputCollector = __webpack_require__(/*! ../client/permission-output-collector.prototype */ "./src/client/permission-output-collector.prototype.js");

var _permissionOutputCollector2 = _interopRequireDefault(_permissionOutputCollector);

var _termCollector = __webpack_require__(/*! ../client/term-collector.prototype */ "./src/client/term-collector.prototype.js");

var _termCollector2 = _interopRequireDefault(_termCollector);
  ...
  if (document.querySelector("#edit-permissions-by-term-info") !== null) {
    ...
    Drupal.behaviors.nodeForm = {
      attach: function () {
        ...
        /*#__PURE__*/
        regeneratorRuntime.mark(function _callee() {
          var backend, hasTaxonomyFormFields;
          return regeneratorRuntime.wrap(function _callee$(_context) {
            while (1) {
              switch (_context.prev = _context.next) {
                case 0:
                  _context.next = 2;
                  return (0, _createPermission2.default)(_fetchFromBackend2.default);

                case 2:
                  backend = _context.sent;

                  hasTaxonomyFormFields = function hasTaxonomyFormFields(permissions) {
                  ...
                  if (hasTaxonomyFormFields(backend)) {
                    (function () {
                      var processPermissionsDisplay = function processPermissionsDisplay() {
                        var permissionOutput = new _permissionOutput2.default(),
                            termCollector = new _termCollector2.default(),
                            domClient = new _domClient2.default(document, permissionOutput, Drupal);
                        var permissionOutputCollector = new _permissionOutputCollector2.default(permissionOutput);
                        var _iteratorNormalCompletion = true;
                        var _didIteratorError = false;
                        var _iteratorError = undefined;

                        try {
                          for (var _iterator = backend.getFieldWrapperCSSClasses()[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
                            var formElementCssClass = _step.value;
                      ...
                      try {
                        for (var _iterator2 = backend.getFieldWrapperCSSClasses()[Symbol.iterator](), _step2; !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {
                          var formElementCssClass = _step2.value;
    ...
    if (Drupal.autocomplete) {
      ...
      Drupal.autocomplete.options.select = function selectHandler(event, ui) {
        var terms = Drupal.autocomplete.splitValues(event.target.value); // Remove the current input.
        ...
        event.target.value = terms.join(', '); // Fire custom event that other controllers can listen to.

        jQuery(event.target).trigger('autocomplete-select'); // Return false to tell jQuery UI that we've filled in the value
        // already.
...
/***/ "./src/model/backend.prototype.js":
/*!****************************************!*\
  !*** ./src/model/backend.prototype.js ***!
  \****************************************/
/*! no static exports found */
...
var Backend = function Backend() {
  ...
  var tidToUsernames = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : [];
  var tidToRoles = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : [];
...
/***/ "./src/model/permission-output.prototype.js":
/*!**************************************************!*\
  !*** ./src/model/permission-output.prototype.js ***!
  \**************************************************/
/*! no static exports found */
...
var PermissionOutput = function PermissionOutput() {
  this.roles = [];
  this.usernames = [];
};
/**
...
exports.default = PermissionOutput;

/***/ }),

/***/ 0:
/*!*****************************************************************************!*\
  !*** multi whatwg-fetch ./src/drupal-behavior-function/node-form-client.js ***!
  \*****************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

__webpack_require__(/*! whatwg-fetch */"./node_modules/whatwg-fetch/fetch.js");
module.exports = __webpack_require__(/*! ./src/drupal-behavior-function/node-form-client.js */"./src/drupal-behavior-function/node-form-client.js");
